...
import { Bell, Clock, Globe2, KeyRound, Layers, Link2, Mail, Palette, Settings2, ShieldCheck, Sparkles, Stethoscope, UserCircle2 } from "lucide-react"
...
import { ClientTypesTab } from "./ClientTypesTab"
...
/** `license`, `mail`, `domain`, `external` and `clientTypes` live only in this screen, so they stay out of the deep-link Tab union. */
type LocalTab = Tab | "license" | "mail" | "domain" | "external" | "clientTypes"
...
export function SettingsClient({ me, brand: initialBrand, info, initialTab }: { me: AdminDto; brand: Brand; info: SystemInfo; initialTab?: Tab }) {
	...
	const clientTypesTab: TabItem<LocalTab> = { id: "clientTypes", label: L("\u0646\u0648\u0639 \u06a9\u0644\u0627\u06cc\u0646\u062a \u0648 \u0633\u0642\u0641\u200c\u0647\u0627", "Client types & caps"), icon: Layers }
	...
	return (
		<div className="space-y-6 fade-up">
			...
			{tab === "clientTypes" && isOwner && <ClientTypesTab />}
