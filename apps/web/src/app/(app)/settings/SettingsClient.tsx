...
import { Bell, Clock, Palette, Settings2, ShieldCheck, Sparkles, Stethoscope, UserCircle2 } from "lucide-react"
...
export function SettingsClient({ me, brand: initialBrand, info, initialTab }: { me: AdminDto; brand: Brand; info: SystemInfo; initialTab?: Tab }) {
	...
	const alertsTab: TabItem<Tab> = { id: "alerts", label: L("هشدار و سیاست‌ها", "Alerts & policies"), icon: Bell }
	...
	return (
		<div className="space-y-6 fade-up">
			<PageHeader
				title={t("set_title")}
				subtitle={L("حساب، امنیت، نشست، برندینگ، ظاهر، سیستم، هشدارها و عیب‌یابی", "Account, security, session, branding, appearance, system, alerts and diagnostics")}
				actions={
					<>
