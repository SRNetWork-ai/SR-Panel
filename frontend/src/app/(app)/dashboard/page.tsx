...
const GB = 1024 ** 3;
const tip = {
  contentStyle: { background: "rgba(11,11,22,0.92)", border: "1px solid rgba(139,92,246,0.25)", borderRadius: 12, color: "#fafafa", fontSize: 12 },
...
function MetricBar({ label, pct }: { label: string; pct: number }) {
  ...
  return (
    <div>
      ...
      <div className="h-1.5 w-full rounded-full bg-zinc-200/70 dark:bg-white/[0.07]">
      ...
      <Card>
        ...
        <ResponsiveContainer width="100%" height={260}>
          <AreaChart data={seriesData} margin={{ top: 10, right: 10, left: 10, bottom: 0 }}>
            ...
            <CartesianGrid vertical={false} stroke="rgba(139,92,246,0.16)" strokeOpacity={0.4} />
            ...
            <Tooltip 
              ...
              contentStyle={{ backgroundColor: "rgba(11,11,22,0.92)", borderColor: "rgba(139,92,246,0.25)", borderRadius: "12px", boxShadow: "0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)", padding: "8px 12px" }}
              itemStyle={{ color: "#e4e4e7", fontWeight: 500 }}
              labelStyle={{ color: "#a1a1aa", marginBottom: "4px" }}
              cursor={{ stroke: '#3f3f46', strokeWidth: 1, strokeDasharray: '4 4' }}
            />
            <Area type="monotone" dataKey="bytes" stroke="#8b5cf6" strokeWidth={3} fill="url(#colorBytes)" activeDot={{ r: 6, fill: "#22d3ee", stroke: "#fff", strokeWidth: 2 }} />
          </AreaChart>
        </ResponsiveContainer>
      </Card>
        ...
        <Card className="border-zinc-200 dark:border-zinc-800/60 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={trends.data?.allTime?.newClients ?? []} margin={{ top: 0, right: 0, left: -25, bottom: 0 }}>
              <CartesianGrid vertical={false} stroke="rgba(139,92,246,0.16)" strokeOpacity={0.3} />
              ...
              <Tooltip 
                ...
                contentStyle={{ backgroundColor: "rgba(11,11,22,0.92)", borderColor: "rgba(139,92,246,0.25)", borderRadius: "12px", padding: "8px 12px" }}
                itemStyle={{ color: "#e4e4e7", fontWeight: 500 }}
              />
