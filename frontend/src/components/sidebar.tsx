...
export function Sidebar() {
  ...
  return (
    <aside className="relative z-10 hidden md:flex w-60 flex-col border-e border-zinc-200/60 dark:border-white/[0.07] bg-white/60 dark:bg-white/[0.025] backdrop-blur-xl">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  active
                    ? "nav-active text-zinc-900 dark:text-zinc-50"
                    : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100/70 dark:hover:bg-white/[0.05] hover:text-zinc-700 dark:hover:text-zinc-200",
                )}
              >
                <Icon size={18} />
                {label}
        ...
        {premiumMenus.length > 0 && (
          <>
            <div className="px-5 pt-4 pb-1 text-[10px] font-semibold uppercase tracking-wider text-violet-600/80 dark:text-violet-300/80">
              {t("app.premium")}
            </div>
                ...
                return (
                  <Link
                    ...
                    className={clsx(
                      ...
                      active
                        ? "nav-active text-violet-700 dark:text-violet-200"
                        : "text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100/70 dark:hover:bg-white/[0.05] hover:text-zinc-700 dark:hover:text-zinc-200",
                    )}
                  >
                    <Icon size={18} />
      ...
      <div className="border-t border-zinc-200/60 dark:border-white/[0.07] p-3 mt-auto">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-zinc-500 dark:text-zinc-400 transition-colors hover:bg-zinc-100/70 dark:hover:bg-white/[0.05] hover:text-red-400"
        >
          <LogOut size={18} />
          {t("nav.logout")}
        </button>
