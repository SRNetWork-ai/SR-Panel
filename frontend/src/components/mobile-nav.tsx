...
export function MobileNav() {
  ...
  return (
    <>
      <div className="flex h-14 items-center justify-between border-b border-zinc-200/60 bg-white/70 px-4 backdrop-blur-xl dark:border-white/[0.07] dark:bg-white/[0.03] md:hidden">
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex bg-black/50 backdrop-blur-sm md:hidden">
          <div className="flex h-full w-64 max-w-sm flex-col bg-white dark:bg-[#0a0a14]">
            <div className="flex h-14 items-center justify-between border-b border-zinc-200/60 px-4 dark:border-white/[0.07]">
            ...
            <div className="flex-1 overflow-y-auto py-4">
                    ...
                    <Link
                      ...
                      className={clsx(
                        ...
                        active
                          ...
                          : "text-zinc-500 hover:bg-zinc-100/70 dark:text-zinc-400 dark:hover:bg-white/[0.05]",
                      )}
                    >
                      <Icon size={18} />
                      {label}
              ...
              {premiumMenus.length > 0 ? (
                <>
                  <div className="px-5 pb-1 pt-4 text-[10px] font-semibold uppercase tracking-wider text-violet-600/80 dark:text-violet-300/80">
                    {t("app.premium")}
                  </div>
            ...
            <div className="mt-auto border-t border-zinc-200/60 p-3 dark:border-white/[0.07]">
